...
const InstitutePage = async (props: any) => {
  ...
  const generateRows = () => {
    ...
    for (let i = 0; i < numRows; i++) {
      const seatsInRow =
        i === numRows - 1
          ? totalStudents % MAX_SEATS_PER_ROW
          : MAX_SEATS_PER_ROW;
      const seats = [];
  ...
  return (
    <div className={lato.className}>
      ...
      <h1 className="mx-auto text-4xl font-bold w-full px-8 pt-4 py-4">
        UG (undergraduate) Deets
      </h1>
      <section className="mx-auto max-w-3xl sm:mt-6 p-4">
        <Table className="mt-8">
          <TableCaption>
            Status of UG (undergraduatee) students within the Institute
          </TableCaption>
          <TableHeader>
            <TableRow>
          ...
          <TableBody>
            <TableRow>
              <TableCell className="text-left">
                {extraData["UG-Within-State"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["UG-Outside-State"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["UG-Outside-Country"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["UG-Economically-Backward"]}
              </TableCell>
              <TableCell className="text-right">
                {extraData["UG-Socially-Challenged"]}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
      ...
      <section className="mx-auto max-w-3xl sm:mt-6 p-4">
        <Table className="mt-8">
          <TableCaption>
            Tution Fee Status (Full Tuition Fee Reimursement)
          </TableCaption>
          <TableHeader>
            <TableRow>
          ...
          <TableBody>
            <TableRow>
              <TableCell className="text-left">
                {extraData["UG-full-tuition-fee-reimbursement-from-Government"]}
              </TableCell>
              <TableCell className="text-center">
                {
                  extraData[
                    "UG-full-tuition-fee-reimbursement-from-Institution-Funds"
                  ]
                }
              </TableCell>
              <TableCell className="text-center">
                {
                  extraData[
                    "PG-full-tuition-fee-reimbursement-from-the-Private-Bodies"
                  ]
                }
              </TableCell>
              <TableCell className="text-right">
                {extraData["UG-not-receiving-full-tuition-fee-reimbursement"]}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
      ...
      <hr className="mt-24 border-black" />
      <h1 className="mx-auto text-4xl font-bold w-full px-8 pt-4 py-4">
        PG (undergraduate) Deets
      </h1>
      <section className="mx-auto max-w-xl p-4">
        <Table>
          <TableCaption>
            Number of PG (postgraduatee) students within the Institute
          </TableCaption>
          <TableHeader>
            <TableRow>
          ...
          <TableBody>
            <TableRow>
              <TableCell className="text-left">
                {extraData["PG-2021-22"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["PG-2020-21"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["PG-2019-20"]}
              </TableCell>
              <TableCell className="text-right">
                {extraData["PG-2018-19"]}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
      ...
      <section className="mx-auto max-w-3xl sm:mt-6 p-4">
        <Table className="mt-8">
          <TableCaption>
            Status of PG (postgraduatee) students within the Institute
          </TableCaption>
          <TableHeader>
            <TableRow>
              <TableHead className="text-left">Within State</TableHead>
          ...
          <TableBody>
            <TableRow>
              <TableCell className="text-left">
                {extraData["PG-Within-State"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["PG-Outside-State"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["PG-Outside-Country"]}
              </TableCell>
              <TableCell className="text-center">
                {extraData["PG-Economically-Backward"]}
              </TableCell>
              <TableCell className="text-right">
                {extraData["PG-Socially-Challenged"]}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
      ...
      <section className="mx-auto max-w-3xl sm:mt-6 p-4">
        <Table className="mt-8">
          ...
          <TableBody>
            <TableRow>
              <TableCell className="text-left">
                {extraData["PG-full-tuition-fee-reimbursement-from-Government"]}
              </TableCell>
              <TableCell className="text-center">
                {
                  extraData[
                    "PG-full-tuition-fee-reimbursement-from-Institution-Funds"
                  ]
                }
              </TableCell>
              <TableCell className="text-center">
              ...
              <TableCell className="text-right">
                {extraData["PG-not-receiving-full-tuition-fee-reimbursement"]}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
      ...
      <section className="mx-auto max-w-xl">
        <picture>
          <img
            src="https://res.cloudinary.com/dfyrk32ua/image/upload/v1720795007/deetnuts/catworkinghard_wb8yo7.png"
            alt="cat-working-hard-meme"
