  ...
  return (
    <div className="container mx-auto max-w-xl px-4 py-8 mt-20">
      ...
      <section className="mb-6">
        ...
        <p>
          By accessing or using the DeetNuts website (&ldquo;Site&rdquo;), you
      ...
      <section className="mb-6">
        ...
        <p>
          DeetNuts does not own any of the logos of organizations displayed on
          this website. We do not represent any of these organizations. All
          trademarks, logos, and brand names are the property of their
          respective owners. We do not claim ownership of any of the data
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          that interrupts, damages, or impairs the site. You may not use the
          Site in any manner that could damage, disable, overburden, or impair
          any DeetNuts server, or interfere with any other party&apos;s use and
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          available&rdquo; basis. DeetNuts makes no representations or
      ...
      <section className="mb-6">
        ...
        <p>
          DeetNuts will not be liable for any damages of any kind arising from
      ...
      <section className="mb-6">
        ...
        <p>
          You agree to indemnify, defend, and hold harmless DeetNuts, its
          ...
          your use of the Site or your violation of these Terms and Conditions.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          DeetNuts reserves the right to modify these Terms and Conditions at
          any time without prior notice. Your continued use of the Site
          following any changes indicates your acceptance of the new Terms and
          Conditions.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          contact us at - help@deetnuts.com
        </p>
      </section>
    </div>
  );
