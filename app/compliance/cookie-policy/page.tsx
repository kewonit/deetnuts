  ...
  return (
    ...
    >
      ...
      <section id="inventory">
        ...
        <p>Authentication cookies use host-only scope, <code>SameSite=Lax</code> and high priority. Their values should never be copied into a message, screenshot or support request.</p>
      </section>
