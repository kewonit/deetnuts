  ...
  return (
    ...
    >
      <section id="scope">
        ...
        <p>Public cutoff pages are open to everyone and do not require an account or analytics consent. This notice does not govern an official counselling portal, Google, Supabase, Vercel, YouTube, Cloudinary, a payment checkout, or another independent site you choose to visit.</p>
        ...
        <div className="policy-table-wrap" role="region" aria-label="Information categories table" tabIndex={0}>
          <table className="policy-table">
            ...
            <tbody>
              ...
              <tr><th scope="row">Account and profile data</th><td data-label="What it can include">Google-provided account identifier, email address, display name and avatar; Supabase user and session identifiers; profile name; avatar uploads; email-verification and authentication timestamps.</td><td data-label="Source">You, Google OAuth and Supabase Auth.</td><td data-label="Why it is used">Create and secure an account, maintain a session, display account details and support authenticated features.</td></tr>
      ...
      <section id="disclosures">
        ...
        <div className="policy-table-wrap" role="region" aria-label="Service providers table" tabIndex={0}>
          <table className="policy-table">
            ...
            <tbody>
              <tr><th scope="row">Vercel</th><td data-label="Function">Hosting, content delivery, functions, request routing and operational logs.</td><td data-label="Information involved">Request, network, device, approximate-location, performance and error information; content sent to server endpoints.</td><td data-label="When">When the Service is requested.</td></tr>
              <tr><th scope="row">Supabase</th><td data-label="Function">Authentication, database, storage and server-side service records.</td><td data-label="Information involved">Account, session, profile, avatar, database and limited service-use event data.</td><td data-label="When">When an account or Supabase-backed feature is used.</td></tr>
      ...
      <section id="retention">
        ...
        <ul>
          ...
          <li><strong>Operational logs:</strong> hosting and runtime logs follow the active hosting plan and provider controls. Security evidence may be retained longer when tied to an abuse investigation or legal requirement.</li>
          ...
          <li><strong>Backups:</strong> deleted information may remain temporarily in access-restricted backups until the backup cycle replaces it.</li>
        </ul>
      </section>

      <section id="security">
        <h2>9. Security</h2>
        <p>DEETNUTS uses safeguards appropriate to the nature of the Service, including HTTPS in production, secure response headers, restricted server credentials, input validation, request-size limits, no-store responses for personalised comparisons, authenticated account checks, provider access controls, checksum validation for cutoff artifacts and separation of public pages from account features.</p>
