...
export default async function AllCollegesPage() {
  ...
  // Group by type
  const groupedInstitutes = institutes.reduce((acc, inst) => {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mt-16 prose prose-lg max-w-none">
          ...
          <p>
            ...
            {totalInstitutes} premier engineering institutions in India,
            including the prestigious Indian Institutes of Technology (IITs),
            National Institutes of Technology (NITs), Indian Institutes of
            Information Technology (IIITs), and other Government Funded
            Technical Institutes (GFTIs).
          </p>
          <p>
            ...
            database includes historical cutoff data from 2016 to 2024 across
            all categories and rounds.
          </p>

          <h3 className="text-xl font-black mt-6 mb-3">Key Features</h3>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Complete Institute Coverage:</strong> All{" "}
              {totalInstitutes} institutes under JoSAA counseling
            </li>
            <li>
            ...
            <li>
              <strong>Category-wise Cutoffs:</strong> OPEN, OBC-NCL, SC, ST,
