      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateFilter("institute", value === "all" ? "" : value)
              }
            >
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateFilter("branch", value === "all" ? "" : value)
              }
            >
              <SelectTrigger className="border-2 border-black">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateFilter("seatType", value === "all" ? "" : value)
              }
            >
              <SelectTrigger className="border-2 border-black">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateFilter("quota", value === "all" ? "" : value)
              }
            >
              <SelectTrigger className="border-2 border-black">
        ...
        {showAdvanced && (
          <div className="space-y-4 rounded-lg border-2 border-black p-4 bg-gray-50">
            <h3 className="font-heading text-lg">Range Filters</h3>
