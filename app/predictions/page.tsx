...
import { PredictionsTable } from './data-table';
...
export default function PredictionsPage() {
    ...
    const [pendingFilters, setPendingFilters] = useState<PredictionFilters>(filters);
    ...
    const goToNextPage = () => setPage((p) => Math.min(pagination.totalPages, p + 1));
            ...
            <div className="container mx-auto px-4 py-8 space-y-6">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-lg md:text-xl font-inter text-gray-700 max-w-3xl mx-auto">
                        AI-powered predictions for JEE Main 2026 cutoffs based on historical data and trends.
                        Find your ideal college with predicted ranks and changes from 2025.
                    </p>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                <div className="font-abel text-sm">
                                    Page {page} of {pagination.totalPages} ({pagination.totalRecords}{' '}
                                    total records)
                                </div>
                ...
                <Card className="border-2 border-black shadow-base bg-gradient-to-r from-purple-100 to-yellow-100">
                    ...
                    <CardContent className="space-y-3 font-inter text-sm">
                        <p>
                            <strong>Predicted Rank 2026:</strong> Our AI model&apos;s prediction for the closing
                            rank in 2026 based on historical trends.
                        </p>
                        <p>
                            <strong>Change from 2025:</strong> Positive values (🔴) mean ranks increased
                            (easier to get admission). Negative values (🟢) mean ranks decreased (harder to
                            get admission).
                        </p>
                        <p>
                            <strong>% Change:</strong> The percentage change in cutoff ranks compared to
                            2025.
                        </p>
                        <p className="text-xs text-gray-600 mt-4">
                            ⚠️ These predictions are based on historical data and should be used as a
                            reference only. Actual cutoffs may vary based on exam difficulty, number of
