    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Explore detailed cutoff data for all rounds of MHT-CET 2024 All India
          quota. Use filters to find specific courses, colleges, or percentile
          ranges.
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          Use the branch filter to narrow down to specific engineering
          disciplines.
