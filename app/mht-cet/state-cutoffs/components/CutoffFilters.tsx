...
export function CutoffFilters({
  ...
  const handleHomeUniversityToggle = useCallback(
      ...
      <CardHeader className="pb-4 border-b border-gray-200">
        <CardTitle className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-abel text-xl font-bold text-gray-900">
                Search Filters
              </h3>
              <p className="text-sm text-gray-600 font-abel mt-1">
          ...
          {hasUnsavedChanges && (
            <Badge
              variant="neutral"
              className="font-abel bg-amber-100 text-amber-800 border-amber-300 text-sm px-3 py-1 animate-pulse"
            >
              Changes Pending
            </Badge>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-3 md:p-5 space-y-3 md:space-y-4">
            ...
            <p className="text-xs md:text-sm text-blue-700 font-abel leading-relaxed">
              Select which round of MHT-CET counseling data to view. Each round
              has different cutoff scores.
            </p>
            <Select
            ...
            <div className="relative">
              <Input
                ...
                onChange={(e) => {
                  ...
                  const percentileRegex =
                    /^(100(\.0{1,7})?|[0-9]{1,2}(\.\d{0,7})?)$/;

                  // First check if it matches the pattern or is a partial valid input
                  const partialRegex =
                    /^(100(\.0{0,7})?|[0-9]{1,2}(\.\d{0,7})?|\.)$/;
              ...
              <div className="flex items-start gap-2 p-2 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-xs sm:text-sm text-blue-700 font-abel">
                  {(() => {
                    ...
                    if (isNaN(target))
                      return "Please enter a valid percentile number";
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="neutral"
                className="justify-between h-12 font-abel text-sm md:text-base hover:bg-blue-50 border-2 hover:border-blue-300 transition-all duration-200"
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {pendingFilters.categories.length > 0 && (
                    <Badge
                      variant="default"
                      className="ml-2 text-xs px-2 py-0 font-abel bg-blue-600 text-white"
                    >
            ...
            <PopoverContent className="w-96 md:w-[450px] p-0 max-h-[85vh] overflow-hidden shadow-xl border-2">
              <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-semibold font-abel text-base md:text-lg text-blue-900">
                    Select Categories
                  </h4>
                  <Button
                    variant="link"
                    ...
                    ([group, categories]) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          <Label className="text-sm font-semibold text-gray-800 font-abel">
                            {group}
                          </Label>
                          <Button
                            variant="link"
                            ...
                            onClick={() => {
                              const allSelected = categories.every((cat) =>
                                pendingFilters.categories.includes(cat),
                              );
                              if (allSelected) {
                                setPendingFilters((prev) => ({
                                  ...prev,
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {categories.map((category) => (
                            <div
                              key={category}
                              className="flex items-center space-x-2 p-1 hover:bg-white rounded transition-colors"
                            >
                              <Checkbox
                                id={category}
                              ...
                              <Label
                                htmlFor={category}
                                className="text-xs font-abel cursor-pointer leading-tight text-gray-700 hover:text-gray-900"
                              >
                                {category}
                              </Label>
                            </div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="neutral"
                className="justify-between h-12 font-abel text-sm md:text-base hover:bg-green-50 border-2 hover:border-green-300 transition-all duration-200"
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {pendingFilters.courses.length > 0 && (
                    <Badge
                      variant="default"
                      className="ml-2 text-xs px-2 py-0 font-abel bg-green-600 text-white"
                    >
            ...
            <PopoverContent className="w-96 md:w-[500px] p-0 max-h-[85vh] overflow-hidden shadow-xl border-2">
              <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-semibold font-abel text-base md:text-lg text-green-900">
                    Select Courses
                  </h4>
                  <Button
                    variant="link"
                    ...
                    >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const allSelected = courses.every((course) =>
                              pendingFilters.courses.includes(course),
                            );
                            if (allSelected) {
                              setPendingFilters((prev) => ({
                                ...prev,
                      ...
                      <div className="space-y-2">
                        {courses.map((course) => (
                          <div
                            key={course}
                            className="flex items-start space-x-2 p-1 hover:bg-white rounded transition-colors"
                          >
                            <Checkbox
                              id={course}
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="neutral"
                className="justify-between h-12 font-abel text-sm md:text-base hover:bg-orange-50 border-2 hover:border-orange-300 transition-all duration-200"
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {pendingFilters.statuses.length > 0 && (
                    <Badge
                      variant="default"
                      className="ml-2 text-xs px-2 py-0 font-abel bg-orange-600 text-white"
                    >
            ...
            <PopoverContent className="w-80 md:w-[450px] p-0 max-h-[85vh] overflow-hidden shadow-xl border-2">
              <div className="p-4 bg-gradient-to-r from-orange-50 to-amber-50 border-b">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-semibold font-abel text-base md:text-lg text-orange-900">
                    Select Status
                  </h4>
                  <Button
                    variant="link"
              ...
              <ScrollArea className="h-96 bg-white">
                <div className="px-4 pb-4 pt-2 space-y-2">
                  {STATUS_OPTIONS.map((option) => (
                    <div
                      key={option.value}
                      className="flex items-start space-x-3 p-2 hover:bg-gray-50 rounded transition-colors border border-gray-100"
                    >
                      <Checkbox
                        id={option.value}
                      ...
                      <Label
                        ...
                        className="text-xs font-abel leading-tight cursor-pointer text-gray-700 hover:text-gray-900 flex-1"
                      >
                        {option.label}
                      </Label>
                    </div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="neutral"
                className="justify-between h-12 font-abel text-sm md:text-base hover:bg-teal-50 border-2 hover:border-teal-300 transition-all duration-200"
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {pendingFilters.homeUniversities.length > 0 && (
                    <Badge
                      variant="default"
                      className="ml-2 text-xs px-2 py-0 font-abel bg-teal-600 text-white"
                    >
            ...
            <PopoverContent className="w-80 md:w-[450px] p-0 max-h-[85vh] overflow-hidden shadow-xl border-2">
              <div className="p-4 bg-gradient-to-r from-teal-50 to-cyan-50 border-b">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-semibold font-abel text-base md:text-lg text-teal-900">
                ...
                <div className="px-4 pb-4 pt-2 space-y-2">
                  {HOME_UNIVERSITY_OPTIONS.map((option) => (
                    ...
                    >
                      <Checkbox
                        id={option.value}
                        checked={pendingFilters.homeUniversities.includes(
                          option.value,
                        )}
                        onCheckedChange={() =>
                          handleHomeUniversityToggle(option.value)
                        }
        ...
        {!pendingFilters.percentileInput ? (
          ...
          <div className="flex items-center justify-center gap-2 p-3 md:p-4 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <span className="text-xs md:text-sm font-medium text-amber-800 font-abel text-center">
              You have unsaved filter changes. Click &quot;Search Cutoffs&quot;
              to apply them.
            </span>
          </div>
        ) : null}
