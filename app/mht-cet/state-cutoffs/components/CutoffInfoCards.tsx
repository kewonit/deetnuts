        ...
        <Card className="relative bg-gradient-to-br from-blue-50 to-white border-blue-200 shadow-lg transition-all duration-300 overflow-hidden">
          ...
          <CardContent className="space-y-4 pt-3">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Step 1 */}
              <section
                className="flex flex-col items-center text-center p-3 bg-blue-50 rounded-xl border border-blue-100 shadow-sm"
              ...
              >
                ...
                <h3
                  id="step1-title"
                  className="text-base md:text-lg font-bold text-blue-900 mb-1"
                >
                  Enter Percentile
                </h3>
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                  Type your MHT-CET percentile (e.g.,{" "}
                  <span className="font-semibold">95.5</span>). Shows colleges
                  with cutoffs ≤ your percentile.
                </p>
              </section>
              {/* Step 2 */}
              <section
              ...
              >
                ...
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                  ...
                  <span className="font-semibold">seat types</span>, and{" "}
                  <span className="font-semibold">university regions</span>.
                </p>
              </section>
              {/* Step 3 */}
              <section
              ...
              >
                ...
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                  ...
                  <span className="font-semibold">highest cutoff</span>. Use to
                  plan your{" "}
                  <span className="font-semibold">CAP round choices</span>.
                </p>
              </section>
            </div>
            <div className="mt-3 p-2 bg-amber-50 border-l-4 border-amber-400 rounded-r-lg flex items-start gap-2">
              ...
              <span className="text-xs md:text-sm font-abel text-amber-900">
                <span className="font-bold">Tip:</span> This tool uses official
                DTE Maharashtra cutoff data. Always cross-verify with official
                sources.
              </span>
            </div>
          </CardContent>
          ...
          <CardContent className="pt-4">
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded-xl bg-green-50/80 border border-green-100 p-4 shadow-sm">
                <div className="font-extrabold text-green-900 font-abel text-xl md:text-2xl mb-1">
                  State Level (S)
                </div>
                <p className="text-base text-gray-700">
                  <span className="font-semibold">Who:</span> All Maharashtra
                  students.
                </p>
              </div>
              ...
              <div className="rounded-xl bg-blue-50/80 border border-blue-100 p-4 shadow-sm">
                <div className="font-extrabold text-blue-900 font-abel text-xl md:text-2xl mb-1">
                  Home University (H)
                </div>
                <p className="text-base text-gray-700">
                  <span className="font-semibold">Who:</span> Students whose
                  Home University matches the college&apos;s university region.
                </p>
                <p className="text-sm text-gray-600 mt-1">
                  <span className="font-semibold">
                    What is Home University?
                  </span>{" "}
                  The university region where you completed your 12th standard
                  (HSC).
                </p>
              </div>
              ...
              <div className="rounded-xl bg-orange-50/80 border border-orange-100 p-4 shadow-sm">
                <div className="font-extrabold text-orange-900 font-abel text-xl md:text-2xl mb-1">
                  Other University (O)
                </div>
                <p className="text-base text-gray-700">
                  <span className="font-semibold">Who:</span> Students from
                  other university regions.
                </p>
              </div>
                  ...
                  <table className="min-w-full text-base font-abel border-collapse">
                    <thead>
                      <tr className="bg-purple-100">
                        <th className="px-3 py-2 border border-purple-200 text-left">
                          Type
                        </th>
                        <th className="px-3 py-2 border border-purple-200 text-left">
                          Code
                    ...
                    <tbody>
                      <tr>
                        <td className="px-3 py-2 border border-purple-100 font-semibold">
                          State Level
                        </td>
                        <td className="px-3 py-2 border border-purple-100 font-mono text-base">
                          S
                        </td>
                        <td className="px-3 py-2 border border-purple-100">
                          All Maharashtra students
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-2 border border-purple-100 font-semibold">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded-xl bg-emerald-50/80 border border-emerald-100 p-4 shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-emerald-900 font-abel text-lg md:text-xl">
                    Category Code Format
                  </span>
                </div>
                <ul className="text-base font-abel space-y-1 pl-2">
                  <li>
                    <span className="font-bold">G</span> = General (open to all)
                  </li>
                  <li>
                    <span className="font-bold">L</span> = Ladies (female
                    candidates only)
                  </li>
                  <li>
                    <span className="font-bold">SC/ST/OBC/EWS</span> = Reserved
                    categories
                  </li>
                  <li>
                    <span className="font-bold">OPEN</span> = Open to all within
                    that category
                  </li>
                  <li>
                    <span className="font-bold">H</span> = Home University,{" "}
                    <span className="font-bold">O</span> = Other University,{" "}
                    <span className="font-bold">S</span> = State Level
                  </li>
                </ul>
                <div className="mt-3 text-sm text-emerald-900 font-abel bg-emerald-100 rounded px-3 py-2">
                  ...
                  = General, Open seat, Home University.
                  <br />
                  <b>Tip:</b> Codes combine category, gender, and region. Always
                  cross-verify with official DTE Maharashtra sources.
                </div>
              </div>
              ...
              <div className="rounded-xl bg-purple-50/80 border border-purple-100 p-4 shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-purple-900 font-abel text-lg md:text-xl">
                    Special Category Codes
                  </span>
                </div>
                <ul className="text-base font-abel space-y-1 pl-2">
                  <li>
                    <span className="font-bold">TFWS:</span> Tuition Fee Waiver
                    Scheme
                  </li>
                  <li>
                    <span className="font-bold">EWS:</span> Economically Weaker
                    Section
                  </li>
                  <li>
                    <span className="font-bold">DEF:</span> Defence Reserved
                  </li>
                  <li>
                    <span className="font-bold">PWD:</span> Persons with
                    Disability
                  </li>
                  <li>
                    <span className="font-bold">MI:</span> Minority Institutions
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl bg-emerald-50/80 border border-emerald-100 p-4 shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                  <Info className="h-5 w-5 text-emerald-600" />
                  <span className="font-semibold text-emerald-900 font-abel text-lg md:text-xl">
                    Video Explanation (not affiliated)
                  </span>
                </div>
                <div className="aspect-video w-full max-w-full rounded overflow-hidden">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube-nocookie.com/embed/1WA_Vh1jaU4?si=bBGUzsa5AoHX6ONh"
