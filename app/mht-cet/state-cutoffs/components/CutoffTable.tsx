...
export function CutoffTable({
  ...
  const exportToCSV = useCallback(() => {
    ...
    try {
      ...
      const fileName = `mht-cet-cutoffs-${
        filters.year
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="px-2 sm:px-3">
            <Badge
              variant="neutral"
              className="font-abel text-xs sm:text-sm w-fit font-medium"
            >
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const showDistance =
            ...
            !isNaN(parseFloat(filters.percentileInput));
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="flex flex-col items-end gap-1 w-[120px] sm:w-[140px] px-2 sm:px-3">
                      ...
                      <Badge
                        variant="neutral"
                        className={`text-xs px-1 py-0 font-abel ${
                          isTarget
        ...
        size:
          filters.percentileInput && !isNaN(parseFloat(filters.percentileInput))
            ? 140
            : 100,
      },
    ];
    ...
    <div className="space-y-4">
          ...
          <Table>
            <TableHeader>
              {table.getHeaderGroups().map((headerGroup) => (
                <TableRow
                  key={headerGroup.id}
                  className="h-10 md:h-12 bg-muted/30"
                >
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center gap-2 text-muted-foreground">
                      ...
                      <span className="font-abel text-sm md:text-base">
                        No cutoff data found matching your criteria
                      </span>
                      <span className="text-xs font-abel">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-2 md:px-4 py-2 md:py-3 gap-3 md:gap-4">
        <div className="flex items-center space-x-2">
          <p className="text-xs md:text-sm font-medium font-abel">
            Rows per page
          </p>
          <Select
            value={`${itemsPerPage}`}
