...
import { homeCardsRowClass } from "@ejam/ui/components/app-layout";
import { ToolCardGrid, type ToolCardItem } from "@ejam/ui/components/ui/tools-card";
import { homeCardPillClass } from "@ejam/ui/lib/pressable";
...
const HOME_TOOL_CARDS: ToolCardItem[] = [
  {
    ...
    pill: {
      label: "try tool",
      iconSrc: "/ejam/icons/magic.svg",
    },
  },
  {
    name: "Scholarship Finder",
    breadcrumb: "generic / tools",
    img: "/ejam/media/hat.png",
    imgClassName:
