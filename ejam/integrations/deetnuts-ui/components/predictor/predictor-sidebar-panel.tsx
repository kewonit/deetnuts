...
import { sidebarPanelTopInsetClass } from "@ejam/ui/components/app-layout";
import { AccuracyReportBanner } from "@ejam/ui/components/predictor/accuracy-report-banner";
import { ExamPicker } from "@ejam/ui/components/predictor/exam-picker";
import { HomeStateCombobox } from "@ejam/ui/components/predictor/home-state-combobox";
import { MhtCetProfileFields } from "@ejam/ui/components/predictor/mht-cet/profile-fields";
import { OptionPicker } from "@ejam/ui/components/predictor/option-picker";
import { usePredictor } from "@ejam/ui/components/predictor/predictor-context";
import { RankInput } from "@ejam/ui/components/predictor/rank-input";
import { SidebarFilterSection } from "@ejam/ui/components/predictor/sidebar-filter-section";
import {
  OptionToggle,
  PredictAction,
  SetupField,
} from "@ejam/ui/components/predictor/sidebar-form-controls";
import { useSidebar } from "@ejam/ui/components/ui/sidebar";
import type { CounsellingBody } from "@ejam/ui/hooks/use-predictor-state";
...
function PredictorSidebarPanelInner() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <div className="mt-auto border-t border-border px-2 py-2 text-[10px] text-muted-foreground">
        Predictor powered by{" "}
        <a
