...
} from "@/ejam-ui/components/predictor/long-shot-visibility";
import { usePredictor } from "@/ejam-ui/components/predictor/predictor-context";
import { programKey } from "@/ejam-ui/components/predictor/program-key";
import {
  applyResultsFilters,
  EMPTY_RESULTS_FILTERS,
} from "@/ejam-ui/components/predictor/results-filter-logic";
import { applyResultsSearch } from "@/ejam-ui/components/predictor/results-search-logic";
import {
  applyResultsSort,
  type ResultsSortKey,
} from "@/ejam-ui/components/predictor/results-sort-logic";
import { useSidebar } from "@/ejam-ui/components/ui/sidebar";
import {
  type PredictorDisplayProgram,
  supportedSortModes,
} from "@/ejam-ui/lib/predictor-adapters";
...
export function Dashboard() {
  ...
  return (
    <div className="h-full min-h-0 w-full min-w-0 bg-border p-px">
...
function renderMiddle({
  ...
  exam: import("@/ejam-ui/hooks/use-predictor-state").ExamType;
