...
import { XIcon } from "lucide-react-ejam";
  ...
  return (
    <SheetPortal>
      ...
      >
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="sheet-close-hit absolute top-4 right-4 z-10 rounded-none"
                size="icon-sm"
              />
            }
          >
        ...
        <div className="sheet-scroll no-scrollbar min-h-0 flex-1 overflow-y-auto">
          {children}
        </div>
      </SheetPrimitive.Popup>
    </SheetPortal>
