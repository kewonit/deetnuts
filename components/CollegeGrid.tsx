    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white border-4 border-black rounded-base shadow-base p-4 sm:p-8 mb-8">
                <div className="mb-6">
                    <h2 className="text-3xl font-heading text-black mb-2">Find Your Perfect College</h2>
                    <p className="text-lg font-base text-black">Use the filters below to narrow down your search</p>
                </div>
            ...
            {filteredColleges.length === 0 ? (
                <div className="bg-white p-12 rounded-base shadow-base text-center border-4 border-black">
                    <div className="max-w-md mx-auto">
                        ...
                        <h3 className="text-2xl font-bold text-black mb-2">No colleges found</h3>
                        <p className="text-black mb-6">Try adjusting your search criteria or filters to find more results.</p>
                        <button
                            onClick={() => {
                                setSearchTerm('');
                                setStatusFilter('all');
