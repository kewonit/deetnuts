...
export default function CutoffsTable({ data, isLoading, error }: CutoffsTableProps) {
    ...
    if (!data || data.length === 0) {
        return (
            <div className="bg-yellow-100 border-4 border-yellow-500 text-yellow-700 px-4 py-3 rounded-base relative text-center" role="alert">
                <strong className="font-bold font-heading">No Cutoff Data!</strong>
                <p className="font-base">Cutoff information for this college is not currently available. Please check back later.</p>
            </div>
        );
    }
            ...
            <div className="p-6">
                        ...
                        <TableBody>
                            {filteredData.map((row) => (
                                <TableRow key={row.id} className="hover:bg-gray-100">
                                    ...
                                    <TableCell className="font-semibold">{row.cutoff_score}</TableCell>
                ...
                {filteredData.length === 0 && (
                    <div className="text-center p-8">
                        <p className="font-heading text-lg">No results found for your filters.</p>
