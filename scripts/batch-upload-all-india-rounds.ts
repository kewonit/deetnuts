...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log(
        "  npm run upload-all-india upsert [csv-file] [collection-suffix]",
      );
      console.log(
        "  npm run upload-all-india clear [csv-file] [collection-suffix]",
      );
      console.log(
        "  npm run upload-all-india replace [csv-file] [collection-suffix]",
      );
      console.log("");
      console.log("Examples:");
      console.log(
        "  npm run upload-all-india create all-india-2024-round-one.csv one",
      );
      console.log(
        "  npm run upload-all-india create all-india-2024-round-two.csv two",
      );
      console.log(
        "  npm run upload-all-india create all-india-2024-round-three.csv three",
      );
      break;
  }
}
